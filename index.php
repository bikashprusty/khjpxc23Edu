...
<meta name="author" content="OMD-technologies">
<!--[if lt IE 9]>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          ...
          <li><a href="#Features" class="scroll-link">Courses</a></li>                    
          <li><a href="#work" class="scroll-link">Testimonial</a></li>
          <li><a href="#enquiry" class="scroll-link">Enquiry</a></li>
          <li><a href="#contact2Us" class="scroll-link">Contact Us</a></li>
        </ul>
      </div>
      <!--/.navbar-collapse--> 
    </nav>
...
<section id="home">
  ...
  <div class="carousel-inner">
    ...
    <div class="item"><img src="images/banner-bg5.jpg" alt="banner" /></div>
    <div class="item"><img src="images/banner-bg6.jpg" alt="banner" /></div>
  </div>
  <!-- Carousel nav -->
  ...
  <div class="container hero-text2">        
		<div class="col-md-9">
		<h2>Only Education.com</h1>
			<p>A quick Brown Fox umpes over the lazy Dog.A quick Brown Fox umpes over the lazy Dog.A quick Brown Fox umpes over the lazy Dog.A quick Brown Fox umpes over the lazy Dog.A quick Brown Fox umpes over the lazy Dog.  </p>   
		</div>  
		<div class="col-md-3 hiden hidden">
    ...
    <div class="row feature design">
      <div class="area1 columns left">
        ...
        <p>Odio quaeque reformidans est eu, expetendis intellegebat has ut, viderer invenire ut his. Has molestie percipit an. Falli volumus efficiantur sed id, ad vel noster propriae. Ius ut etiam vivendo, graeci iudicabit constituto at mea. No soleat fabulas prodesset vel, ut quo solum dicunt.
          ...
          <a href="#" class="btn">Send us an Enquiry</a>
      </div>
...
<section id="enquiry" class="contact-parlex">
    ...
    <div class="container">
      <div class="row">
        <div class="heading text-center"> 
          <!-- Heading -->
          <h2>Enquiry</h2>
          <p>You can write to us on any concerns if you have any.</p>
        </div>
      </div>
        ...
        <form method="post" action="" id="contactfrm" role="form">
          <div class="col-sm-12">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="address" id="address" placeholder="Enter address" title="Please enter a valid address">
            </div>
            <div class="form-group">
              <label for="telephone">Telephone</label>
              <input type="text" class="form-control" name="telephone" id="telephone" placeholder="Enter telephone" title="Please enter a valid telephone number">
            </div>
            <div class="form-group">
              <label for="mobile">Mobile</label>
              <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Enter mobile" title="Please enter a valid mobile number">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="course" id="course" placeholder="Enter course" title="Please enter a valid course">
            </div>
            <div class="form-group">
...
<section id="contact2Us" class="contact-parlex">
  <div class="parlex-back">
    <div class="container">
      <div class="row">
        <div class="heading text-center"> 
...
<a href="#top" class="topHome"><i class="fa fa-chevron-up fa-2x">Top</i></a> 
